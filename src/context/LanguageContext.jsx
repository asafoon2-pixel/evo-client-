...
export const translations = {
  he: {
    ...
    home_midburn: 'מידברן 26 – חבילות מלאות לקאמפים',
    home_midburn_sub: 'צליל · תאורה · בר · קייטרינג · הפקה מלאה · אוהלי פרימיום · עיצוב מדברי',
  ...
  en: {
    ...
    home_midburn: 'Midburn 26 – Full Camp Packages',
    home_midburn_sub: 'Sound · Lighting · Bar · Catering · Full production · Premium tents · Desert décor',
