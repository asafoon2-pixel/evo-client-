...
// ── Divider ───────────────────────────────────────────────────────────────────
function Divider() {
  return <div className="my-10 mx-0 h-px" style={{ background: 'var(--border)' }} />
}
    ...
    <div className="w-full min-h-screen overflow-y-auto pb-32" style={{ background: 'var(--background)' }}>
      ...
      <div className="relative px-6 pt-16 pb-10 text-center overflow-hidden">
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(45,27,105,0.12) 0%, transparent 70%)' }} />
          ...
          <div>
            ...
            <div className="px-1">
              <div className="flex gap-2 mb-3">
                {[1,2,3,4,5].map(n => {
                  const active = form.energy_level >= n
                  return (
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md px-6 py-4 z-30"
        ...
        <motion.button
          ...
          style={{
            ...
            background: canSubmit ? 'var(--primary)' : 'var(--surface)',
