      ...
      <div className="px-6 space-y-10 pt-8">
        ...
        <motion.button {...f(0.1)} onClick={() => setShowFilmModal(true)} whileTap={{ scale: 0.98 }}
          ...
          <div className="text-left">
            <p className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>Watch Your Event Preview</p>
        ...
        <motion.div {...f(0.15)}>
          ...
          <p className="text-lg font-light tracking-wide" style={{ color: 'var(--text-primary)' }}>{previewSections[0].descriptor}</p>
        </motion.div>
        ...
        {previewSections.slice(1).map((section, i) => (
          <motion.div key={section.id} {...f(0.2 + i * 0.07)}>
            ...
            <div className="mt-4">
              <p className="text-lg font-light" style={{ color: 'var(--text-primary)' }}>{section.descriptor}</p>
          ...
          <motion.div
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1 }}>
                <p className="font-display text-2xl font-light mb-3" style={{ color: 'var(--text-primary)' }}>{event.name}</p>
